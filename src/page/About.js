  ...
  return (
    <div className={styles.backgroundLayer}>
      <section className={styles.container}>
        ...
        <br></br>
        <p>
          This is a project which uses an open (free to use) personality
          questionnaire to measure big 5 personality traits: Neuroticism,
          Extraversion, Agreeableness, Openness and Conscientiousness.
        </p>
        <p>
          The norms (achieved score compared to the participants age and gender
          group) were defined based on a dataset which consisted of more than
          15.000 participants and can be found on{" "}
